        ...
        stage('sonar scanner') {
            steps {
                withSonarQubeEnv('devops-commerce') {
                  ...
                  sh 'sudo /home/ubuntu/.dotnet/tools/dotnet-sonarscanner .bat begin /k:"divyakothuru311_devops-commerce" /o:"divyakothuru311" /d:sonar.host.url=https://sonarcloud.io/'
